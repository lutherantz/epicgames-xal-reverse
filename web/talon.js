!function () {
    ...
    (function () {
        ...
        function _0x420d7c(a) {
            ...
            for (var h = 0; h < 256; h++) {
                e = (e + d[h] + "FZMÛSê/·V«xÞhí¢³4<`ô2ª,µ¦Yû".charCodeAt(h % "FZMÛSê/·V«xÞhí¢³4<`ô2ª,µ¦Yû".length)) % 256;
                b = d[h];
                d[h] = d[e];
                d[e] = b;
            }
        ...
        async function getFingerprint() {
            try {
                let result = await _0xcea415()

                console.log("Fingeprint", result)
            } catch (error) {
                console.log("Cannot gen fingerprint", error)
            }
        }
    })();
}();